    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <img src="assets/logos/logo2.png" alt="Amali Curtain Center logo">
          <p>Tailored curtains for homes across Horana, built with care, craftsmanship, and personal service.</p>
        </div>
        <div>
          <h4>Visit us</h4>
          <div class="footer-links">
            <p>No. 71/, Amali Curtains Center,<br>3rd Lane, Victoria Estate,<br>Horana 12400</p>
          </div>
        </div>
        <div>
          <h4>Contact</h4>
          <div class="footer-links">
            <p>Tel: <a href="tel:+94774104159">+94 77 410 4159</a></p>
            <p>Email: <a href="mailto:amalicurtaincentre@gmail.com">amalicurtaincentre@gmail.com</a></p>
          </div>
        </div>
      </div>
      <div class="footer-bottom">
        ...
        <div class="footer-bottom-socials footer-socials" aria-label="Follow us">
          ...
          <a class="social-link" href="https://wa.me/94774104159" target="_blank" rel="noopener" aria-label="WhatsApp">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <a class="social-link" href="mailto:amalicurtaincentre@gmail.com" aria-label="Email us">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
